...
const navItems: NavItem[] = [
  {
    ...
    path: '/',
    icon: ({ active }) => (
      <svg xmlns="http://www.w3.org/2000/svg" className={`h-6 w-6 ${active ? 'text-black dark:text-white' : 'text-black dark:text-slate-400'}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
